...
{
    public class DisposableStreamResource1_Derived : DisposableStreamResource
    {
        ...
        public DisposableStreamResource1_Derived(string fileName) : base(fileName) => _fileName = fileName;
